...
/// Application state
pub static APP: AppCell<VersmApp> = AppCell::new();

/// Versm Application
#[derive(Debug)]
pub struct VersmApp {
    /// Application configuration.
    config: CfgCell<VersmConfig>,
...
impl Application for VersmApp {
    /// Entrypoint command for this application.
    type Cmd = EntryPoint<VersmCmd>;
    ...
    fn tracing_config(&self, command: &EntryPoint<VersmCmd>) -> trace::Config {
        if command.verbose {
